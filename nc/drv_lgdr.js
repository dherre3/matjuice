...
function PNxx_Legendre_vectN_MS(x, n){
    ...
    if (mc_t155) {
        ...
        mc_t190 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t190, 1, mc_t112);
        wi.set_f64(PNxxa, mc_t187, mc_t190);
    }
    ...
    if (mc_t168) {
        ...
        for (j = mc_t167; j<=mc_t135; j = j+1) {
            ...
            mc_t192 = wi.colon_two(1, 5);
            wi.set_array_index_i32(mc_t191, 1, mc_t192);
            mc_t193 = wi.convert_scalar_to_mxarray(mc_t128);
            wi.set_array_index_i32(mc_t191, 2, mc_t193);
            mc_t127 = wi.get_f64(PNxxa, mc_t191);
            mc_t121 = wi.times_MM(mc_t126, mc_t127);
            mc_t164 = 4;
            mc_t123 = j + mc_t164;
            mc_t165 = 2;
            mc_t125 = j + mc_t165;
            mc_t194 = wi.create_mxvector(2, 5);
            mc_t195 = wi.colon_two(1, 5);
            wi.set_array_index_i32(mc_t194, 1, mc_t195);
            mc_t196 = wi.convert_scalar_to_mxarray(mc_t125);
            wi.set_array_index_i32(mc_t194, 2, mc_t196);
            mc_t124 = wi.get_f64(PNxxa, mc_t194);
            mc_t122 = wi.mtimes_SM(mc_t123, mc_t124);
            mc_t120 = wi.minus_MM(mc_t121, mc_t122);
            mc_t113 = wi.mtimes_SM(mc_t119, mc_t120);
            mc_t166 = 4;
            mc_t115 = j + mc_t166;
            mc_t197 = wi.create_mxvector(2, 5);
            mc_t198 = wi.colon_two(1, 5);
            wi.set_array_index_i32(mc_t197, 1, mc_t198);
            mc_t199 = wi.convert_scalar_to_mxarray(mc_t115);
            wi.set_array_index_i32(mc_t197, 2, mc_t199);
            mc_t200 = wi.create_mxvector(1);
            wi.set_array_index_f64(mc_t200, 1, mc_t113);
            wi.set_f64(PNxxa, mc_t197, mc_t200);
        }
    ...
    for (j = mc_t173; j<=mc_t141; j = j+1) {
        ...
        mc_t136 = wi.get_f64(PNxxa, mc_t201);
        mc_t139 = j;
        mc_t171 = 1;
        mc_t172 = 2;
        ...
        mc_t204 = wi.create_mxvector(2, 5);
        mc_t205 = wi.colon_two(1, 5);
        wi.set_array_index_i32(mc_t204, 1, mc_t205);
        mc_t206 = wi.convert_scalar_to_mxarray(j);
        wi.set_array_index_i32(mc_t204, 2, mc_t206);
        mc_t207 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t207, 1, mc_t114);
        wi.set_f64(PNxxa, mc_t204, mc_t207);
    }
...
function drv_lgdr_S(scale){
    ...
    mc_t208 = wi.create_mxvector(5, 5);
    mc_t209 = wi.convert_scalar_to_mxarray(mc_t1);
    wi.set_array_index_i32(mc_t208, 1, mc_t209);
    mc_t210 = wi.convert_scalar_to_mxarray(mc_t2);
    wi.set_array_index_i32(mc_t208, 2, mc_t210);
    mc_t211 = wi.convert_scalar_to_mxarray(mc_t3);
    wi.set_array_index_i32(mc_t208, 3, mc_t211);
    mc_t212 = wi.convert_scalar_to_mxarray(mc_t4);
    wi.set_array_index_i32(mc_t208, 4, mc_t212);
    mc_t213 = wi.convert_scalar_to_mxarray(mc_t5);
    wi.set_array_index_i32(mc_t208, 5, mc_t213);
    x = wi.horzcat(mc_t208);
    n = 5;
    mc_t6 = 1;
...
function PN_Legendre_vectN_MS(x, n){
    ...
    wi.set_array_index_f64(mc_t214, 1, mc_t11);
    wi.set_array_index_f64(mc_t214, 2, mc_t12);
    PNa = wi.zeros(mc_t214);
    mc_t34 = 1;
    mc_t35 = 1;
    mc_t215 = wi.create_mxvector(2, 5);
    mc_t216 = wi.colon_two(1, 5);
    wi.set_array_index_i32(mc_t215, 1, mc_t216);
    mc_t217 = wi.convert_scalar_to_mxarray(mc_t35);
    wi.set_array_index_i32(mc_t215, 2, mc_t217);
    mc_t218 = wi.create_mxvector(1);
    wi.set_array_index_f64(mc_t218, 1, mc_t34);
    wi.set_f64(PNa, mc_t215, mc_t218);
    wi.size(PNa);
    mc_t39 = 0;
    mc_t38 = n > mc_t39;
    if (mc_t38) {
        ...
        mc_t221 = wi.convert_scalar_to_mxarray(mc_t37);
        wi.set_array_index_i32(mc_t219, 2, mc_t221);
        mc_t222 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t222, 1, mc_t7);
        wi.set_f64(PNa, mc_t219, mc_t222);
    }
    ...
    if (mc_t48) {
        ...
        for (j = mc_t47; j<=mc_t26; j = j+1) {
            ...
            mc_t225 = wi.convert_scalar_to_mxarray(mc_t21);
            wi.set_array_index_i32(mc_t223, 2, mc_t225);
            mc_t20 = wi.get_f64(PNa, mc_t223);
            ...
            mc_t228 = wi.convert_scalar_to_mxarray(j);
            wi.set_array_index_i32(mc_t226, 2, mc_t228);
            mc_t18 = wi.get_f64(PNa, mc_t226);
            ...
            mc_t231 = wi.convert_scalar_to_mxarray(mc_t10);
            wi.set_array_index_i32(mc_t229, 2, mc_t231);
            mc_t232 = wi.create_mxvector(1);
            wi.set_array_index_f64(mc_t232, 1, mc_t8);
            wi.set_f64(PNa, mc_t229, mc_t232);
        }
    ...
    for (j = mc_t53; j<=mc_t32; j = j+1) {
        mc_t233 = wi.create_mxvector(2, 5);
        mc_t234 = wi.colon_two(1, 5);
        wi.set_array_index_i32(mc_t233, 1, mc_t234);
        mc_t235 = wi.convert_scalar_to_mxarray(j);
        wi.set_array_index_i32(mc_t233, 2, mc_t235);
        mc_t27 = wi.get_f64(PNa, mc_t233);
        mc_t30 = j;
        mc_t51 = 1;
        mc_t52 = 2;
        ...
        mc_t238 = wi.convert_scalar_to_mxarray(j);
        wi.set_array_index_i32(mc_t236, 2, mc_t238);
        mc_t239 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t239, 1, mc_t9);
        wi.set_f64(PNa, mc_t236, mc_t239);
    }
...
function PNx_Legendre_vectN_MS(x, n){
    ...
    mc_t84 = 1;
    mc_t59 = n + mc_t84;
    mc_t240 = wi.create_mxvector(2);
    wi.set_array_index_f64(mc_t240, 1, mc_t58);
    wi.set_array_index_f64(mc_t240, 2, mc_t59);
    PNxa = wi.zeros(mc_t240);
    mc_t85 = 0;
    mc_t86 = 1;
    mc_t241 = wi.create_mxvector(2, 5);
    mc_t242 = wi.colon_two(1, 5);
    wi.set_array_index_i32(mc_t241, 1, mc_t242);
    mc_t243 = wi.convert_scalar_to_mxarray(mc_t86);
    wi.set_array_index_i32(mc_t241, 2, mc_t243);
    mc_t244 = wi.create_mxvector(1);
    wi.set_array_index_f64(mc_t244, 1, mc_t85);
    wi.set_f64(PNxa, mc_t241, mc_t244);
    mc_t90 = 0;
    mc_t89 = n > mc_t90;
    if (mc_t89) {
        mc_t87 = 1;
        mc_t88 = 2;
        mc_t245 = wi.create_mxvector(2, 5);
        mc_t246 = wi.colon_two(1, 5);
        wi.set_array_index_i32(mc_t245, 1, mc_t246);
        mc_t247 = wi.convert_scalar_to_mxarray(mc_t88);
        wi.set_array_index_i32(mc_t245, 2, mc_t247);
        mc_t248 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t248, 1, mc_t87);
        wi.set_f64(PNxa, mc_t245, mc_t248);
    }
    ...
    if (mc_t93) {
        ...
        mc_t251 = wi.convert_scalar_to_mxarray(mc_t92);
        wi.set_array_index_i32(mc_t249, 2, mc_t251);
        mc_t252 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t252, 1, mc_t54);
        wi.set_f64(PNxa, mc_t249, mc_t252);
    }
    ...
    if (mc_t106) {
        ...
        for (j = mc_t105; j<=mc_t77; j = j+1) {
            ...
            mc_t255 = wi.convert_scalar_to_mxarray(mc_t70);
            wi.set_array_index_i32(mc_t253, 2, mc_t255);
            mc_t69 = wi.get_f64(PNxa, mc_t253);
            ...
            mc_t258 = wi.convert_scalar_to_mxarray(mc_t67);
            wi.set_array_index_i32(mc_t256, 2, mc_t258);
            mc_t66 = wi.get_f64(PNxa, mc_t256);
            ...
            mc_t261 = wi.convert_scalar_to_mxarray(mc_t57);
            wi.set_array_index_i32(mc_t259, 2, mc_t261);
            mc_t262 = wi.create_mxvector(1);
            wi.set_array_index_f64(mc_t262, 1, mc_t55);
            wi.set_f64(PNxa, mc_t259, mc_t262);
        }
    ...
    for (j = mc_t111; j<=mc_t83; j = j+1) {
        mc_t263 = wi.create_mxvector(2, 5);
        mc_t264 = wi.colon_two(1, 5);
        wi.set_array_index_i32(mc_t263, 1, mc_t264);
        mc_t265 = wi.convert_scalar_to_mxarray(j);
        wi.set_array_index_i32(mc_t263, 2, mc_t265);
        mc_t78 = wi.get_f64(PNxa, mc_t263);
        mc_t81 = j;
        mc_t109 = 1;
        mc_t110 = 2;
        ...
        mc_t266 = wi.create_mxvector(2, 5);
        mc_t267 = wi.colon_two(1, 5);
        wi.set_array_index_i32(mc_t266, 1, mc_t267);
        mc_t268 = wi.convert_scalar_to_mxarray(j);
        wi.set_array_index_i32(mc_t266, 2, mc_t268);
        mc_t269 = wi.create_mxvector(1);
        wi.set_array_index_f64(mc_t269, 1, mc_t56);
        wi.set_f64(PNxa, mc_t266, mc_t269);
    }
