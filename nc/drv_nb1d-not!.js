...
function rand1_SSS(m, n, seed){
    ...
    mc_t75 = m * n;
    seed = mc_t74 + mc_t75;
    mc_t87 = wi.create_mxvector(2);
    wi.set_array_index_f64(mc_t87, 1, m);
    wi.set_array_index_f64(mc_t87, 2, n);
    M = wi.zeros(mc_t87);
    mc_t86 = 1;
    for (i = mc_t86; i<=m; i = i+1) {
        ...
        for (j = mc_t85; j<=n; j = j+1) {
            ...
            wi.set_array_index_f64(mc_t88, 1, i);
            wi.set_array_index_f64(mc_t88, 2, j);
            wi.set_array_value_multiple_indeces_f64(M, mc_t88, mc_t73);
            mc_t78 = seed;
            mc_t89 = wi.create_mxvector(2);
            wi.set_array_index_f64(mc_t89, 1, i);
            wi.set_array_index_f64(mc_t89, 2, j);
            mc_t80 = wi.get_array_value_multiple_indeces_f64(M, mc_t89);
            mc_t83 = 100;
...
function drv_nb1d_S(scale){
    ...
    mc_t90 = nbody1d_SMMMMSS(n, Rx, Ry, Rz, m, dT, T);
    Fx = wi.get_array_index_f64(mc_t90, 1);
    Fy = wi.get_array_index_f64(mc_t90, 2);
    Fz = wi.get_array_index_f64(mc_t90, 3);
    Vx = wi.get_array_index_f64(mc_t90, 4);
    Vy = wi.get_array_index_f64(mc_t90, 5);
    Vz = wi.get_array_index_f64(mc_t90, 6);
