...
function capacitor_SSSSSSS(a, b, c, d, n, tol, rel){
    ...
    mc_t52 = 1;
    mc_t31 = m + mc_t52;
    f = mc_zeros(mc_t30, mc_t31);
    mc_t53 = 1;
    mc_t34 = n + mc_t53;
    mc_t54 = 1;
    mc_t35 = m + mc_t54;
    mc_t32 = mc_ones(mc_t34, mc_t35);
    mc_t33 = rel;
    mask = mc_mtimes_MS(mc_t32, mc_t33);
    ...
    for (ii = mc_t60; ii<=mc_t37; ii = ii+1) {
        ...
        for (jj = mc_t59; jj<=mc_t36; jj = jj+1) {
            mc_t57 = 0;
            mask[((ii-1)+(mask.mj_stride()[1]*(jj-1)))] = mc_t57;
            mc_t58 = 1;
            f[((ii-1)+(f.mj_stride()[1]*(jj-1)))] = mc_t58;
        }
    }
...
function linspace_SSS(d1, d2, n){
    ...
    mc_t179 = n - mc_t180;
    mc_t181 = 0;
    mc_t177 = mc_colon(mc_t181, mc_t179);
    mc_t178 = d2 - d1;
    mc_t175 = mc_mtimes_MS(mc_t177, mc_t178);
    mc_t182 = 1;
    mc_t176 = n - mc_t182;
    mc_t174 = mc_mrdivide_MS(mc_t175, mc_t176);
    mc_t171 = mc_plus_SM(mc_t173, mc_t174);
    mc_t172 = d2;
    y = mc_horzcat(mc_t171, mc_t172);
...
function seidel_MMSSSS(f, mask, n, m, na, mb){
    ...
    for (ii = mc_t158; ii<=n; ii = ii+1) {
        ...
        for (jj = mc_t157; jj<=m; jj = jj+1) {
            mc_t89 = f[((ii-1)+(f.mj_stride()[1]*(jj-1)))];
            mc_t91 = mask[((ii-1)+(mask.mj_stride()[1]*(jj-1)))];
            mc_t152 = 1;
            mc_t108 = ii - mc_t152;
            mc_t109 = jj;
            mc_t104 = f[((mc_t108-1)+(f.mj_stride()[1]*(mc_t109-1)))];
            mc_t153 = 1;
            mc_t106 = ii + mc_t153;
            mc_t107 = jj;
            mc_t105 = f[((mc_t106-1)+(f.mj_stride()[1]*(mc_t107-1)))];
            mc_t100 = mc_t104 + mc_t105;
            mc_t102 = ii;
            mc_t154 = 1;
            mc_t103 = jj - mc_t154;
            mc_t101 = f[((mc_t102-1)+(f.mj_stride()[1]*(mc_t103-1)))];
            mc_t96 = mc_t100 + mc_t101;
            mc_t98 = ii;
            mc_t155 = 1;
            mc_t99 = jj + mc_t155;
            mc_t97 = f[((mc_t98-1)+(f.mj_stride()[1]*(mc_t99-1)))];
            mc_t95 = mc_t96 + mc_t97;
            mc_t156 = 0.25000000000000000000;
            mc_t93 = mc_t156 * mc_t95;
            mc_t94 = f[((ii-1)+(f.mj_stride()[1]*(jj-1)))];
            mc_t92 = mc_t93 - mc_t94;
            mc_t90 = mc_t91 * mc_t92;
            mc_t86 = mc_t89 + mc_t90;
            f[((ii-1)+(f.mj_stride()[1]*(jj-1)))] = mc_t86;
        }
    }
    ...
    for (jj = mc_t164; jj<=m; jj = jj+1) {
        mc_t110 = f[((ii-1)+(f.mj_stride()[1]*(jj-1)))];
        mc_t112 = mask[((ii-1)+(mask.mj_stride()[1]*(jj-1)))];
        mc_t159 = 1;
        mc_t129 = ii + mc_t159;
        mc_t130 = jj;
        mc_t125 = f[((mc_t129-1)+(f.mj_stride()[1]*(mc_t130-1)))];
        mc_t160 = 1;
        mc_t127 = ii + mc_t160;
        mc_t128 = jj;
        mc_t126 = f[((mc_t127-1)+(f.mj_stride()[1]*(mc_t128-1)))];
        mc_t121 = mc_t125 + mc_t126;
        mc_t123 = ii;
        mc_t161 = 1;
        mc_t124 = jj - mc_t161;
        mc_t122 = f[((mc_t123-1)+(f.mj_stride()[1]*(mc_t124-1)))];
        mc_t117 = mc_t121 + mc_t122;
        mc_t119 = ii;
        mc_t162 = 1;
        mc_t120 = jj + mc_t162;
        mc_t118 = f[((mc_t119-1)+(f.mj_stride()[1]*(mc_t120-1)))];
        mc_t116 = mc_t117 + mc_t118;
        mc_t163 = 0.25000000000000000000;
        mc_t114 = mc_t163 * mc_t116;
        mc_t115 = f[((ii-1)+(f.mj_stride()[1]*(jj-1)))];
        mc_t113 = mc_t114 - mc_t115;
        mc_t111 = mc_t112 * mc_t113;
        mc_t87 = mc_t110 + mc_t111;
        f[((ii-1)+(f.mj_stride()[1]*(jj-1)))] = mc_t87;
    ...
    for (ii = mc_t170; ii<=n; ii = ii+1) {
        mc_t131 = f[((ii-1)+(f.mj_stride()[1]*(jj-1)))];
        mc_t133 = mask[((ii-1)+(mask.mj_stride()[1]*(jj-1)))];
        mc_t165 = 1;
        mc_t150 = ii - mc_t165;
        mc_t151 = jj;
        mc_t146 = f[((mc_t150-1)+(f.mj_stride()[1]*(mc_t151-1)))];
        mc_t166 = 1;
        mc_t148 = ii + mc_t166;
        mc_t149 = jj;
        mc_t147 = f[((mc_t148-1)+(f.mj_stride()[1]*(mc_t149-1)))];
        mc_t142 = mc_t146 + mc_t147;
        mc_t144 = ii;
        mc_t167 = 1;
        mc_t145 = jj + mc_t167;
        mc_t143 = f[((mc_t144-1)+(f.mj_stride()[1]*(mc_t145-1)))];
        mc_t138 = mc_t142 + mc_t143;
        mc_t140 = ii;
        mc_t168 = 1;
        mc_t141 = jj + mc_t168;
        mc_t139 = f[((mc_t140-1)+(f.mj_stride()[1]*(mc_t141-1)))];
        mc_t137 = mc_t138 + mc_t139;
        mc_t169 = 0.25000000000000000000;
        mc_t135 = mc_t169 * mc_t137;
        mc_t136 = f[((ii-1)+(f.mj_stride()[1]*(jj-1)))];
        mc_t134 = mc_t135 - mc_t136;
        mc_t132 = mc_t133 * mc_t134;
        mc_t88 = mc_t131 + mc_t132;
        f[((ii-1)+(f.mj_stride()[1]*(jj-1)))] = mc_t88;
    }
...
function gauss_SSSM(n, m, h, f){
    ...
    for (ii = mc_t80; ii<=n; ii = ii+1) {
        mc_t64 = q;
        mc_t67 = f[((ii-1)+(f.mj_stride()[1]*(m-1)))];
        mc_t78 = 1;
        mc_t69 = ii + mc_t78;
        mc_t70 = m;
        mc_t68 = f[((mc_t69-1)+(f.mj_stride()[1]*(mc_t70-1)))];
    ...
    for (jj = mc_t83; jj<=m; jj = jj+1) {
        mc_t71 = q;
        mc_t74 = f[((n-1)+(f.mj_stride()[1]*(jj-1)))];
        mc_t76 = n;
        mc_t81 = 1;
        mc_t77 = jj + mc_t81;
        mc_t75 = f[((mc_t76-1)+(f.mj_stride()[1]*(mc_t77-1)))];
