...
function babai_MM(R, y){
    ...
    for (k = mc_t21; k>=mc_t28; k = k+mc_t22) {
        ...
        mc_t15 = k + mc_t26;
        mc_t16 = n;
        mc_t14 = mc_colon(mc_t15, mc_t16);
        mc_t8 = mc_slice_get(R, [mc_t13, mc_t14]);
        mc_t27 = 1;
        mc_t11 = k + mc_t27;
        mc_t12 = n;
        mc_t10 = mc_colon(mc_t11, mc_t12);
        mc_t9 = mc_slice_get(z_hat, [mc_t10]);
        par = mc_mtimes_MM(mc_t8, mc_t9);

        mc_t19 = y[(k-1)];
        mc_t20 = par;
        mc_t17 = mc_t19 - mc_t20;
        mc_t18 = R[((k-1)+(R.mj_stride()[1]*(k-1)))];
        ck = mc_t17 / mc_t18;
        mc_t4 = mc_round_S(ck);
        z_hat[(k-1)] = mc_t4;
    }
