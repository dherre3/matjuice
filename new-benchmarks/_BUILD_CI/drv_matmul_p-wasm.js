...
function drv_matmul_p_S(scale){
    ...
    wi.set_array_index_f64(mc_t17, 2, k);
    A = wi.rand(mc_t17);
    mc_t18 = wi.create_mxvector(2);
    wi.set_array_index_f64(mc_t18, 1, k);
    wi.set_array_index_f64(mc_t18, 2, n);
    B = wi.rand(mc_t18);
