...
function babai_MM(R, y){
    ...
    n = mc_length_M(y);
    mc_t28 = 1;
    z_hat = mc_zeros(n, mc_t28);
    mc_t11 = y[(n-1)];
    mc_t12 = R[((n-1)+(1000*(n-1)))];
    mc_t10 = mc_t11 / mc_t12;
    mc_t8 = mc_round_S(mc_t10);
    z_hat[(n-1)] = mc_t8;
    mc_t29 = 1;
    mc_t26 = n - mc_t29;
    mc_t30 = 1;
    ...
    for (k = mc_t26; k>=mc_t33; k = k+mc_t27) {
        ...
        mc_t20 = k + mc_t31;
        mc_t21 = n;
        mc_t19 = mc_colon(mc_t20, mc_t21);
        mc_t13 = mc_slice_get(R, [mc_t18, mc_t19]);
        mc_t32 = 1;
        mc_t16 = k + mc_t32;
        mc_t17 = n;
        mc_t15 = mc_colon(mc_t16, mc_t17);
        mc_t14 = mc_slice_get(z_hat, [mc_t15]);
        par = mc_mtimes_MM(mc_t13, mc_t14);

        mc_t24 = y[(k-1)];
        mc_t25 = par;
        mc_t22 = mc_t24 - mc_t25;
        mc_t23 = R[((k-1)+(1000*(k-1)))];
        ck = mc_t22 / mc_t23;
        mc_t9 = mc_round_S(ck);
        z_hat[(k-1)] = mc_t9;
    }
