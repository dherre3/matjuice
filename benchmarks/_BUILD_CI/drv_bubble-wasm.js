...
function drv_bubble_S(size){
    ...
    var mc_t0 = 0;
    mc_t0 = 1;
    mc_t21 = wi.create_mxvector(2);
    wi.set_array_index_f64(mc_t21, 1, size);
    wi.set_array_index_f64(mc_t21, 2, mc_t0);
    A = wi.rand(mc_t21);
    mc_t1 = 10000;
    ...
    for (j = mc_t20; j<=mc_t12; j = j+1) {
        ...
        for (i = mc_t19; i<=mc_t11; i = i+1) {
            ...
            if (mc_t18) {
                ...
                wi.set_array_index_f64(A, i, mc_t5);
                mc_t17 = 1;
                mc_t6 = i + mc_t17;
                wi.set_array_index_f64(A, mc_t6, temp);
            }
        }
    }
    x = A;
