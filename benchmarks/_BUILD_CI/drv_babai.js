...
function babai_MM(R, y){
    ...
    n = mc_length_M(y);
    mc_t24 = 1;
    z_hat = mc_zeros(n, mc_t24);
    mc_t7 = y[(n-1)];
    mc_t8 = R[((n-1)+(R.mj_stride()[1]*(n-1)))];
    mc_t6 = mc_t7 / mc_t8;
    mc_t4 = mc_round_S(mc_t6);
    z_hat[(n-1)] = mc_t4;
    mc_t25 = 1;
    mc_t22 = n - mc_t25;
    mc_t26 = 1;
    ...
    for (k = mc_t22; k>=mc_t29; k = k+mc_t23) {
        ...
        mc_t16 = k + mc_t27;
        mc_t17 = n;
        mc_t15 = mc_colon(mc_t16, mc_t17);
        mc_t9 = mc_slice_get(R, [mc_t14, mc_t15]);
        mc_t28 = 1;
        mc_t12 = k + mc_t28;
        mc_t13 = n;
        mc_t11 = mc_colon(mc_t12, mc_t13);
        mc_t10 = mc_slice_get(z_hat, [mc_t11]);
        par = mc_mtimes_MM(mc_t9, mc_t10);

        mc_t20 = y[(k-1)];
        mc_t21 = par;
        mc_t18 = mc_t20 - mc_t21;
        mc_t19 = R[((k-1)+(R.mj_stride()[1]*(k-1)))];
        ck = mc_t18 / mc_t19;
        mc_t5 = mc_round_S(ck);
        z_hat[(k-1)] = mc_t5;
    }
