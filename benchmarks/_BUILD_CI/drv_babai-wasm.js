...
function babai_MM(R, y){
    ...
    wi.set_array_index_f64(mc_t30, 2, mc_t24);
    z_hat = wi.zeros(mc_t30);
    mc_t7 = wi.get_array_index_f64(y, n);
    mc_t8 = wi.get_array_index_f64(R, (((n-1)+(wi.get_array_stride(R, 1)*(n-1)))+1));
    mc_t6 = mc_t7 / mc_t8;
    mc_t4 = wi.round_S(mc_t6);
    wi.set_array_index_f64(z_hat, n, mc_t4);
    mc_t25 = 1;
    mc_t22 = n - mc_t25;
    mc_t26 = 1;
    mc_t23 = -mc_t26;
    mc_t29 = 1;
    for (k = mc_t22; k>=mc_t29; k = k+mc_t23) {
        mc_t14 = k;
        mc_t27 = 1;
        mc_t16 = k + mc_t27;
        mc_t17 = n;
        mc_t31 = wi.create_mxvector(2, 5);
        mc_t32 = wi.convert_scalar_to_mxarray(mc_t16);
        wi.set_array_index_i32(mc_t31, 1, mc_t32);
        mc_t33 = wi.convert_scalar_to_mxarray(mc_t17);
        wi.set_array_index_i32(mc_t31, 2, mc_t33);
        mc_t15 = wi.colon(mc_t31);
        mc_t34 = wi.create_mxvector(2, 5);
        mc_t35 = wi.convert_scalar_to_mxarray(mc_t14);
        wi.set_array_index_i32(mc_t34, 1, mc_t35);
        wi.set_array_index_i32(mc_t34, 2, mc_t15);
        mc_t9 = wi.get_f64(R, mc_t34);
        mc_t28 = 1;
        mc_t12 = k + mc_t28;
        mc_t13 = n;
        mc_t36 = wi.create_mxvector(2, 5);
        mc_t37 = wi.convert_scalar_to_mxarray(mc_t12);
        wi.set_array_index_i32(mc_t36, 1, mc_t37);
        mc_t38 = wi.convert_scalar_to_mxarray(mc_t13);
        wi.set_array_index_i32(mc_t36, 2, mc_t38);
        mc_t11 = wi.colon(mc_t36);
        mc_t39 = wi.create_mxvector(1, 5);
        wi.set_array_index_i32(mc_t39, 1, mc_t11);
        mc_t10 = wi.get_f64(z_hat, mc_t39);
        par = wi.mtimes_MM(mc_t9, mc_t10);
        par = wi.get_array_index_f64(par, 1);

        mc_t20 = wi.get_array_index_f64(y, k);
        mc_t21 = par;
        mc_t18 = mc_t20 - mc_t21;
        mc_t19 = wi.get_array_index_f64(R, (((k-1)+(wi.get_array_stride(R, 1)*(k-1)))+1));
        ck = mc_t18 / mc_t19;
        mc_t5 = wi.round_S(ck);
        wi.set_array_index_f64(z_hat, k, mc_t5);
    }
...
function drv_babai_S(size){
    ...
    wi.set_array_index_f64(mc_t40, 2, size);
    R = wi.randn(mc_t40);
    mc_t0 = 1;
    mc_t41 = wi.create_mxvector(2);
    wi.set_array_index_f64(mc_t41, 1, size);
    wi.set_array_index_f64(mc_t41, 2, mc_t0);
    Y = wi.randn(mc_t41);
    wi.tic();
    mc_t2 = 1;
