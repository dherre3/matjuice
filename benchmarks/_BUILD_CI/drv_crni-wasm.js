...
function tridiagonal_MMMMS(A, D, C, B, n){
    ...
    wi.set_array_index_f64(mc_t130, 1, mc_t125);
...
function crnich_SSSSS(a, b, c, n, m){
    ...
    wi.set_array_index_f64(mc_t133, 1, mc_t71);
    wi.set_array_index_f64(mc_t133, 2, mc_t36);
    mc_t35 = wi.ones(mc_t133);
    ...
    wi.set_array_index_f64(mc_t134, 1, mc_t75);
    wi.set_array_index_f64(mc_t134, 2, mc_t38);
    mc_t37 = wi.ones(mc_t134);
    ...
    wi.set_array_index_f64(mc_t135, 1, mc_t78);
    ...
    for (j1 = mc_t90; j1<=m; j1 = j1+1) {
        ...
        mc_t89 = 1;
        mc_t136 = wi.create_mxvector(2, 5);
        mc_t137 = wi.convert_scalar_to_mxarray(mc_t89);
        wi.set_array_index_i32(mc_t136, 1, mc_t137);
        mc_t138 = wi.convert_scalar_to_mxarray(n);
        wi.set_array_index_i32(mc_t136, 2, mc_t138);
        mc_t7 = wi.colon(mc_t136);
        mc_t8 = j1;
        mc_t139 = wi.create_mxvector(2, 5);
        wi.set_array_index_i32(mc_t139, 1, mc_t7);
        mc_t140 = wi.convert_scalar_to_mxarray(mc_t8);
        wi.set_array_index_i32(mc_t139, 2, mc_t140);
        wi.set_f64(U, mc_t139, mc_t5);
    }
