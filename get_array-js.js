...
function get_array_S(scale){
    ...
    mc_t5 = 2;
    mc_t6 = 1;
    mc_t4 = mc_horzcat(mc_t5, mc_t6);
    mc_t8 = 2;
    mc_t9 = 3;
    mc_t7 = mc_horzcat(mc_t8, mc_t9);
    G = mc_vertcat(mc_t4, mc_t7);

    mc_t10 = 3;
    mc_t11 = 6;
    mc_t12 = 2;
    mc_tic();
    A = mc_randn(mc_t10, mc_t11, mc_t12);
    console.log(mc_toc());
    mc_t13 = 3;
    mc_t14 = 2;
    mc_t15 = 1;
    e = A[(((mc_t13-1)+(3*(mc_t14-1)))+(18*(mc_t15-1)))];
    mc_disp_M(G);
    mc_tic();
    mc_t18 = 2;
    mc_t19 = 3;
    mc_t0 = mc_horzcat(mc_t18, mc_t19);
    mc_t20 = 2;
    mc_t21 = 8;
    // A = mc_colon(mc_t20, mc_t0, mc_t21);
    console.log(mc_toc());
    mc_disp_M(A);
    ...
    mc_t24 = 7;
    mc_t25 = 3;
    B = mc_ones(mc_t23, mc_t24, mc_t25);
    mc_t26 = 1;
    mc_t27 = 2;
    mc_t1 = mc_colon(mc_t26, mc_t27);
    mc_t29 = 1;
    mc_t30 = 2;
    mc_t2 = mc_horzcat(mc_t29, mc_t30);
    mc_t31 = 2;
    mc_tic();
    D = mc_slice_get(B, [mc_t1, mc_t2, mc_t31]);
    console.log("SLICE GET: ", mc_toc());
    // mc_disp_M(D);
    mc_t33 = 7;
    mc_t34 = 2;
    mc_tic();
    A = mc_randn(scale, mc_t33, mc_t34);
    console.log("Allocation: ", mc_toc());
    mc_tic();
    mc_t39 = 1;
    for (i = mc_t39; i<=scale; i = i+1) {
        mc_t37 = 7;
        mc_t38 = 2;
        A[(((i-1)+(1000000*(mc_t37-1)))+(7000000*(mc_t38-1)))] = i;
    }
    mc_disp_S(A[10]);
    t = mc_toc();
    console.log("LOOP",t)
