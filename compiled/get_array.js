...
function get_array_S(scale){
    ...
    mc_t1 = 7;
    mc_t2 = 2;
    mc_t9 = wi.create_mxvector(3);
    wi.set_array_index_f64(mc_t9, 1, scale);
    wi.set_array_index_f64(mc_t9, 2, mc_t1);
    wi.set_array_index_f64(mc_t9, 3, mc_t2);
    A = wi.randn(mc_t9);
    t = wi.toc();
    wi.disp_S(t);
    wi.tic();
    ...
    for (i = mc_t7; i<=scale; i = i+1) {
        mc_t5 = 7;
        mc_t6 = 2;
        mc_t10 = wi.create_mxvector(3);
        wi.set_array_index_f64(mc_t10, 1, i);
        wi.set_array_index_f64(mc_t10, 2, mc_t5);
        wi.set_array_index_f64(mc_t10, 3, mc_t6);
        wi.set_array_value_multiple_indeces_f64(A, mc_t10, i);
    }
    t = wi.toc();
    wi.disp_S(t);
    return;
